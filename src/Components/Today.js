      ...
      <div className='w-100'>
        ...
        <div className="w-100">
          ...
          <div className="row d-flex justify-content-around text-center bg-primary py-3">
            <span className="h4">(مباشر) احصائيات كورونا في الجزائر<br /> COVID-19 STATISTICS IN ALGERIA (LIVE) </span>
          </div>
        ...
        <div>
          <div className="row d-flex justify-content-around text-center bg-primary py-3">
            <span className="h4">(مباشر) احصائيات كورونا في العالم<br /> COVID-19 STATISTICS IN THE WORLD (LIVE) </span>
          </div>
